; =================================================================
;
; KumaranOS -- The Kumaran Operating System kernel
; 
; ==================================================================
...
os_draw_background:
	...
	mov ah, 09h			; Draw Black bar at top and red letters
	mov bh, 0
	mov cx, 80
	mov bl, 00001100b
	mov al, ' '
	...
	mov ah, 09h			; Draw Black bar at bottom and red letters
	mov bh, 0
	mov cx, 80
	mov bl, 00001100b
	mov al, ' '
...
os_draw_background3:
	...
	mov cx, 00001100b		; Colour: red text on Black background
	...
	mov ah, 09h			; Draw gray bar at top
	mov bh, 0
	mov cx, 80
	mov bl, 01110000b
	mov al, ' '
	...
	mov ah, 09h			; Draw g bar at bottom
	mov bh, 0
	mov cx, 80
	mov bl, 01110000b
	mov al, ' '
...
os_dialog_box:
	...
	mov dh, 4			; First, draw red background box
	mov dl, 5
...
.one_button:
	...
	mov dl, 36			; OK button, centred at bottom of box
	mov dh, 14
	call os_move_cursor
...
.noright:
	...
	.ok_button_string	db 'Menu', 0
	.cancel_button_string	db 'Exit', 0
	.ok_button_noselect	db '   Menu   ', 0
...
.noright:
	...
	.ok_button_string	db 'HD-I', 0
	.cancel_button_string	db 'BACK', 0
	.ok_button_noselect	db 'HD-I', 0
	.cancel_button_noselect	db '   BACK   ', 0
